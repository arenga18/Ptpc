            ...
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('admin/transaksi/cek_pembayaran') ?>">
                    ...
                    <?php foreach($pembayaran as $pb) : ?>
                        ...
                        <a class="btn btn-sm btn-success" href="<?php echo base_url('admin/transaksi/download_pembayaran/'. $pb->id_transaksi) ?>"><i class="fas fa-download"></i> Download Bukti Pembayaran</a>

                        <div class="custom-control custom-switch ml-4">
                            <input type="hidden" class="custom-control-input" value="<?php echo $pb->id_transaksi ?>" name="id_transaksi">
