<section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(<?php echo base_url('assets/gambar/1.png')?>);">
      ...
      <div class="slider-item" style="background-image:url(<?php echo base_url('assets/gambar/2.png')?>);">
      	<div ss="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-md-end align-items-center justify-content-end">
        </div>
    ...
    <section id="about" class="ftco-section bg-light" href="">
      <div class="container">
